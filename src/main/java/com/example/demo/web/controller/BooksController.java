...
public class BooksController extends AbstractController<BooksDTO>{
    ...
    @Autowired
    protected BooksController(MenuService menuService, BooksService service) {
        super(menuService);
    ...
    public String getAll(@RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size,
        ...
        final Page<BooksDTO> all = this.service.findAll(PageRequest.of(page.orElse(1) - 1, size.orElse(10)));
        model
